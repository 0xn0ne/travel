...
@/home/ubuntu/coding/travel/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/ubuntu/coding/travel/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```

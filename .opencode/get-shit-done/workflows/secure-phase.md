...
```
Task(
  prompt="Read /home/ubuntu/coding/travel/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ubuntu/coding/travel/.opencode/get-shit-done/templates/SECURITY.md`

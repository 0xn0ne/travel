...
- **Global scope**: `/home/ubuntu/coding/travel/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/ubuntu/coding/travel/.opencode/notes/`)
...
2. Glob `/home/ubuntu/coding/travel/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/ubuntu/coding/travel/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/ubuntu/coding/travel/.opencode/notes/` — works in any directory

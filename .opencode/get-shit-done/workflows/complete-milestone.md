...
```bash
node "/home/ubuntu/coding/travel/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/home/ubuntu/coding/travel/.opencode/get-shit-done/templates/retrospective.md`.

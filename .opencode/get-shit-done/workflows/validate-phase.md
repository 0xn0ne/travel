...
```
Task(
  prompt="Read /home/ubuntu/coding/travel/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ubuntu/coding/travel/.opencode/get-shit-done/templates/VALIDATION.md`

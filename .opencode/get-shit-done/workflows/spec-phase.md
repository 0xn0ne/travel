...
```bash
INIT=$(node "/home/ubuntu/coding/travel/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/ubuntu/coding/travel/.opencode/get-shit-done/templates/spec.md.

...
<template>
@/home/ubuntu/coding/travel/.opencode/get-shit-done/templates/UAT.md
</template>
...
Read and follow `/home/ubuntu/coding/travel/.opencode/get-shit-done/workflows/transition.md`.
...
```bash
node "/home/ubuntu/coding/travel/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @/home/ubuntu/coding/travel/.opencode/get-shit-done/workflows/diagnose-issues.md

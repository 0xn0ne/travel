...
.diary-cover {
  background: linear-gradient(135deg, #b59bf9 0%, #9a84e6 52%, #ece5ff 100%);
  ...
  overflow: hidden;
  margin-bottom: 12px;
  box-shadow: 0 18px 34px rgba(143, 121, 219, 0.16);
}
...
.timeline-line {
  width: 2px;
  flex: 1;
  background: linear-gradient(to bottom, #c6b6f0, rgba(198, 182, 240, 0.15));
  margin-top: 8px;
  min-height: 52px;
}
...
.poi-card.highlighted {
  border-color: #a78bfa;
  box-shadow: 0 16px 30px rgba(167, 139, 250, 0.14);
  background: #faf7ff;
}
...
.poi-card::before {
  ...
  right: 0;
  height: 3px;
  background: linear-gradient(90deg, #ddd3fe, #9f86ec, #ece6ff);
